...
export const metadata = {
  title: "Lesson 3 - Rule of Life Primer",
  description: "The Four Non-Negotiables and why standards matter.",
};

const PDF_URL =
  process.env.NEXT_PUBLIC_PDF_URL ||
  "https://guardiangritfitness.s3.us-east-005.backblazeb2.com/The+Rule+of+Life+Primer.pdf";
const YOUTUBE_ID = "LESSON3_ID";

const takeaways = [
  "Standards > preferences",
  "Implement one layer at a time",
  "Non-negotiables support execution",
];

const actionStep = "Choose one non-negotiable and commit for 7 days. No stacking yet.";
    ...
    <div className="min-h-screen bg-bone text-charcoal">
      <main className="container-page space-y-10 py-10">
        <section className="space-y-3">
          ...
          <div className="space-y-3 rounded-2xl border border-brass/25 bg-white/70 p-6 shadow-sm shadow-brass/10">
            <div className="space-y-2">
              ...
              <h1 className="font-display text-3xl sm:text-4xl">Lesson 3 - The Four Non-Negotiables</h1>
              <p className="text-slate/90">The point isn't perfection. The point is fewer decisions.</p>
            </div>

            <div className="flex flex-wrap gap-3">
              <CTAButton href="/primer/lesson-2" variant="ghost">
                Previous: Lesson 2
              </CTAButton>
              <CTAButton href="/primer/lesson-4">Next: Lesson 4</CTAButton>
            </div>
          </div>
        </section>
        ...
        <section className="rounded-2xl border border-brass/25 bg-white/70 p-5 shadow-sm shadow-brass/10">
          <div className="space-y-2">
            <h2 className="text-lg font-semibold text-charcoal">Lesson 3 video</h2>
            <p className="text-slate/90">See how to set non-negotiables that remove daily decision fatigue.</p>
          </div>
